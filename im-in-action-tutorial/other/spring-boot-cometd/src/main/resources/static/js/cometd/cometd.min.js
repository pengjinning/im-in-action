var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(l,u,q){l instanceof String&&(l=String(l));for(var A=l.length,z=0;z<A;z++){var H=l[z];if(u.call(q,H,z,l))return{i:z,v:H}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
...
$jscomp.polyfill=function(l,u,q,A){if(u){q=$jscomp.global;l=l.split(".");for(A=0;A<l.length-1;A++){var z=l[A];z in q||(q[z]={});q=q[z]}l=l[l.length-1];A=q[l];u=u(A);u!=A&&null!=u&&$jscomp.defineProperty(q,l,{configurable:!0,writable:!0,value:u})}};$jscomp.polyfill("Array.prototype.find",function(l){return l?l:function(l,q){return $jscomp.findInternal(this,l,q).v}},"es6","es3");
