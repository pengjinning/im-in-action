...
import io.xiaper.action.DefaultIndexAction;
import io.xiaper.action.ErrorAction;
import io.xiaper.annotation.Route;
import io.xiaper.exception.HttpConfigException;
...
public class HttpConfig {
    ...
    public static void setRoot(String root) {
        HttpConfig.root = FileUtil.mkdir(root);
        log.debug("Set root to [{}]", HttpConfig.root.getAbsolutePath());
    }
    ...
    public static void setRoot(File root) {
        if (root.exists() == false) {
            ...
            throw new HttpConfigException(StrUtil.format("{} is not a directory!", root.getPath()));
        }
        HttpConfig.root = root;
    }
    //----------------------------------------------------------------------------------------------- Root end
    ...
    public static void setFilterMap(Map<String, Filter> filterMap) {
        HttpConfig.filterMap = filterMap;
    }
    ...
    public static void setFilter(String path, Filter filter) {
        ...
        HttpConfig.filterMap.put(path, filter);
    }
    ...
    public static void setActionMap(Map<String, Action> actionMap) {
        HttpConfig.actionMap = actionMap;
    }
    ...
    public static void setAction(String path, Action action) {
        ...
        HttpConfig.actionMap.put(path, action);
    }
    ...
    public static void setAction(Action action) {
        ...
        throw new HttpConfigException("Can not find Route annotation,please add annotation to Action class!");
    }
